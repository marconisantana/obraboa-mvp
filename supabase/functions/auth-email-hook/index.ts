...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirme seu e-mail — ObraBoa 🏗️',
  invite: 'Você foi convidado — ObraBoa 🏗️',
  magiclink: 'Seu link de acesso — ObraBoa',
  recovery: 'Redefinir sua senha — ObraBoa 🔑',
  email_change: 'Confirme a alteração do e-mail — ObraBoa',
  reauthentication: 'Código de verificação — ObraBoa 🔐',
}
...
// Configuration
const SITE_NAME = "ObraBoa MVP"
const SENDER_DOMAIN = "notify.obraboa.app.br"
const ROOT_DOMAIN = "obraboa.app.br"
const FROM_DOMAIN = "obraboa.app.br" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://3efb8fef-2426-4466-825f-53e814934bcc.lovableproject.com"
